exports.seed = function (knex, Promise) {
  ...
  return knex('hut')
      ...
      knex('hut').insert([
        {
          ...
          Description: 'Nestled at timberline below the majestic peaks of the Colorado Continental Divide, 10th Mountain Division Hut forms a perfect destination for a single hut trip or ski-through using other nearby huts. In summer, dozens of hiking and cycling routes start or end just outside the door.',
          ...
          Suggested_SUMMER_Vehicle_Access: 'Extreme 4 wheel drive road. High clearance required',
        ...
        },
        {
          ...
          WINTER_Water_Running_water_potable: false,
          WINTER_Water_Spring_stream_lake_non_potable: false,
          Suggested_SUMMER_Vehicle_Access: 'High_clearance 4 wheel drive accessibility',
          SUMMER_Parking_Available_On_site: false,
    ...
    .then(() => knex.raw('ALTER SEQUENCE hut_id_seq RESTART WITH 38;'));
};
