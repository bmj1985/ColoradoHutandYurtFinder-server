exports.up = (knex, Promise) => knex.schema.createTable('hut', (table) => {
  ...
  table.boolean('SUMMER_Water_less_than_one_quarter_mi_to_Spring_stream_lake_non_potable');
  table.boolean('SUMMER_Water_greater_than_one_quarter_mi_to_Spring_stream_lake_non_potable');
...
exports.down = (knex, Promise) => knex.schema.dropTableIfExists('hut');
